...
switch action
    case 'init',
        ...
        next_row(y);
        NumeditParam(obj, 'PoleUpOnWrongTime', 0.5, x, y, 'TooltipString', ...
            'Time the pole stays up after animal made wrong choice');
        next_row(y);
...
%         2017/10/10 JK
        ...
        next_row(y);
        NumeditParam(obj, 'PoleRetractTime', 1, x, y, 'TooltipString', ...
...
%             'LickportTravelTime','RestartPreAnsOnLick'});
        SoloFunctionAddVars('make_and_upload_state_matrix', 'ro_args', ...
            ...
            'RestartPreAnsOnLick', 'PoleUpOnWrongTime'});
