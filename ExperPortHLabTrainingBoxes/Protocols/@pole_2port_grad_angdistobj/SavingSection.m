...
%       set_callback(savedata, {mfilename, 'savedata'}); next_row(y, 1.5);   
      EditParam(obj, 'MouseName', 'AH000', x, y); next_row(y, 1.5);
...
% 
      ...
      EditParam(obj, 'Weight_g_', num2str(0.0), x, y); next_row(y);
      EditParam(obj, 'WeightAfterExp_g_', num2str(0,0), x, y); next_row(y);
      MenuParam(obj, 'HeadFixed', {'Fixed w/o anesthesia','Fixed after anesthesia','Not fixed'},'Fixed w/o anesthesia', x, y); next_row(y);
      MenuParam(obj, 'Lighting', {'IR Security Cam','Diffuse 940nm for Security Cam','940nm High-speed Imaging','White light','Totally Dark'},'940nm High-speed Imaging', x, y); next_row(y);
