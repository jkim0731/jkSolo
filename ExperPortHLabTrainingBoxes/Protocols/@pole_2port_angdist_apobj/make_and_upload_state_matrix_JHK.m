...
%           eto_t = eto_t - puff_t; % JK 01/29/16 We are not having air
%           puff aren't we?
           eto_t = max(eto_t,.01);
           ...
           stm = [stm ;
               ...
               onLickS  onLickS  onLickS  onLickS  sPrAP    pr_t+sp_t pvid       0; ... % sPMS: pole move & sample period % onLickS = sPMS @ line 205
               ...
               sPoTP    sPoTP    sPoTP    sPoTP    35       postp_t   0          0; ... % sPoTP: posttrial pause
               sPun     sPun     sPun     sPun     pps      eto_t     pvid       0; ... % sPun: punish & pps = sPoTP @ line 203
               ...
               sRDel    sRDel    sRDel    sRDel    sPrAP    0.001     0          0; ... % sRDel: restart delay              
               ];
   ...
   judp('SEND', 7000, '68.181.112.192', [uint8(trialnumstr) 10])
   return;
