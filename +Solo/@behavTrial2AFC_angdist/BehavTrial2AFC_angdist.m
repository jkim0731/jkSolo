...
classdef BehavTrial < handle
    ...
    properties
        ...
        sessionName = '';
        trialNum  = [];
        trialType = []; % 1 for right trial, 0 for left trial.
    ...
    methods (Access = public)
        function obj = BehavTrial2AFC_angdist(mouse_name, session_name, trial_num, trial_type,...
            ...
            if nargin > 7
                ...
                obj.motorDistance = varargin{6};
                obj.motorApPosition = varargin{7};
                obj.servoAngle = varargin{8};
            end
        end
...
%                 ', ' trial_type_string ', ' score_string])     
    ...
    methods % Dependent property methods; cannot have attributes.    
        ...
        function value = get.beamBreakTimes(obj)
            ...
            % trialEvents(x,1).
            breakInd = find(obj.trialEvents(:,2)== 1 | 3); % trialEvents(x,2) == 1 means
            ...
            if ~isempty(obj.nextTrialEvents)
                ...
                breakIndITI = find(obj.nextTrialEvents(:,2)==1 | 3); % Get all beam breaks assigned to next trial
