...
%
% JK, 2016/06/20.
% Changed to 2pad(2port-angle & distance). To generalize in 2port
% experiments further changes required
%
%
%
classdef BehavTrial2port < handle
    ...
    methods (Access = public)
        function obj = BehavTrial2port(mouse_name, session_name, trial_num, trial_type,...
